...
public class Testes
{
    ...
    public static void testar() throws InvalidoException, PokemonInexistenteException
    {
        ...
        } catch (HiddenMachineEfeitoExteriorInvalidoException | HiddenMachineEfeitoInvalidoException | HiddenMachineExistenteException | TipoInvalidoException | HiddenMachinePPException | HiddenMachineInexistenteException e) {
            e.printStackTrace();
        }
        ...
        //Remover attack inexistente
        try {
            Attack attack = null;
            fachada.removerAtaque("ataq");
        } catch (AtaqueInexistenteException e) {
            e.printStackTrace();
        }

        //Procurar attack inexistente
        try {
            Attack attack = null;
            fachada.procurarAtaque("ataq");
        } catch (AtaqueInexistenteException e) {
            e.printStackTrace();
        }
    }
